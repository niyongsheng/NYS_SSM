...
<div class="table-responsive" data-pattern="priority-columns">
    ...
    <table id="table-1" class="table table-bordered dataTable table-small-font table-striped display-all"
        ...
        <tr role="row">
            ...
            <th id="table-1-col-2" data-priority="1" class="sorting" tabindex="0" aria-controls="datatable"
                rowspan="1" colspan="1" aria-sort="ascending"
                aria-label=""
        ...
        <c:forEach items="${pagingList}" var="group" varStatus="s">
            ...
            <td data-priority="1" colspan="1" data-columns="table-1-col-8"
                style="display: table-cell;">${group.expireTime}</td>
            <td data-priority="1" colspan="1" data-columns="table-1-col-9"
                style="display: table-cell;">${group.gmtCreate}</td>
