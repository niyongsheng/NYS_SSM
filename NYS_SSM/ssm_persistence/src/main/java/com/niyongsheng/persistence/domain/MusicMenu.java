 ...
 */
@Data
@ApiModel(value ="MusicMenu")
@TableName(value = "dcd_musicMenu")
public class MusicMenu implements Serializable {
  ...
  @TableField(value = "musicList", exist = false)
  ...
  @ApiModelProperty(value = "团契信息")
  @TableField(value = "fellowship", exist = false)
  private Fellowship fel;
}
