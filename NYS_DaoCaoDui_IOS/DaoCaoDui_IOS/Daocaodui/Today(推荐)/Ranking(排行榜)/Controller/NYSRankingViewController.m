...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self setTitle:@"打卡活动"];
    [NNotificationCenter addObserver:self selector:@selector(refreshClockActivityList:) name:@"RefreshClockActivityListNotification" object:nil];
...
- (void)refreshClockActivityList:(NSNotification *)notification {
