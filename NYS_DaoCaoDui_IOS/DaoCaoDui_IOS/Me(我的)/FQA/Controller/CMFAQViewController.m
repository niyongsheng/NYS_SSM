...
@interface CMFAQViewController () <UITableViewDelegate, UITableViewDataSource, CMHeaderViewDelegate>
@property (nonatomic,strong) NSMutableArray *tableDataArray;
@property (nonatomic, strong) UITableView *FAQTableView;
@end

@implementation CMFAQViewController
...
- (UITableView *)FAQTableView {
    if (_FAQTableView == nil) {
        _FAQTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, NScreenWidth, NScreenHeight-NNavBarHeight-NStatusBarHeight) style:UITableViewStylePlain];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    CMHeaderView *header = [[CMHeaderView alloc] init];
...
- (void)headerViewDidClickedNameView:(CMHeaderView *)headerView {
    [self.FAQTableView reloadData];
}
