...
+ (instancetype)headerViewWithTableView:(UITableView *)tableView
{
    ...
    CMHeaderView *header = [tableView dequeueReusableHeaderFooterViewWithIdentifier:ID];
    if (header == nil) {
        header = [[CMHeaderView alloc] initWithReuseIdentifier:ID];
    }
