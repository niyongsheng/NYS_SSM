...
- (UIView *)buildHeaderView {
    ...
    // header
    self.headerView.frame = CGRectMake(0, 0, NScreenWidth, 115);
    // 日期
    self.timeLabel.frame  = CGRectMake(RealValue(22), 30, NScreenWidth/2, 17);
    self.timeLabel.text = [self getWeekDay];
    // 标题
    self.titleLabel.frame = CGRectMake(RealValue(22),55 , (NScreenWidth/3)*2, 30);
    
    // 登录按钮
    self.userButton.frame = CGRectMake(NScreenWidth-44-RealValue(22), 38, 44, 44);
