...
- (id<UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController animationControllerForOperation:(UINavigationControllerOperation)operation fromViewController:(UIViewController *)fromVC toViewController:(UIViewController *)toVC {
    ...
    if ([fromVC conformsToProtocol:@protocol(NYSTransitionProtocol)] && [toVC conformsToProtocol:@protocol(NYSTransitionProtocol)]) {
        
        BOOL pinterestNedd = [self isNeedTransition:fromVC:toVC];
        NYSTransition *transion = [NYSTransition new];
        ...
        return transion;
    } else if ([toVC conformsToProtocol:@protocol(NYSTransitionProtocol)]){
...
- (BOOL)isNeedTransition:(UIViewController<NYSTransitionProtocol> *)fromVC :(UIViewController<NYSTransitionProtocol> *)toVC {
    BOOL a = NO;
    BOOL b = NO;
...
// 判断fromVC和toVC是否需要实现pinterest效果
- (BOOL)isNeedTransition:(UIViewController<NYSTransitionProtocol> *)toVC {
    BOOL b = NO;
    if ([toVC respondsToSelector:@selector(isNeedTransition)] && [toVC isNeedTransition]) {
        b = YES;
    }
