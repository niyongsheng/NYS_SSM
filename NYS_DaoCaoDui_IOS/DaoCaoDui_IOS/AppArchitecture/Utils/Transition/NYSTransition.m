...
@interface NYSTransition ()
/** 缩放比例 */
@property (nonatomic, assign) CGFloat animationScale;
@end

@implementation NYSTransition
- (instancetype)init {
    self = [super init];
    if (self) {
...
- (void)pushAnimateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    UIViewController<NYSTransitionProtocol> * fromVC = (UIViewController <NYSTransitionProtocol> * )[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    UIViewController<NYSTransitionProtocol> * toVC = (UIViewController <NYSTransitionProtocol> * )[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    //from和to的两个视图
    ...
    [UIView animateWithDuration:self.animationDuration animations:^{
        ...
        NAppDelegate.mainTabBar.tabBar.alpha = 0;
...
- (void)popAnimateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    [UIView animateWithDuration:self.animationDuration animations:^{
        ...
        NAppDelegate.mainTabBar.tabBar.alpha = 1;
    } completion:^(BOOL finished) {
        //        if (finished) {
