//
//  NYSMusicCollectionListViewController.m
//  DaoCaoDui_IOS
//
...
@interface NYSMusicCollectionListViewController () <UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) NSMutableArray *datasourceArray;
@property (nonatomic, assign) NSInteger pageNum;

@end

@implementation NYSMusicCollectionListViewController
...
- (void)headerRereshing {
    ...
    WS(weakSelf);
    [NYSRequest getCollectionMusicListWithResMethod:GET
                    parameters:parames
                       success:^(id response) {
