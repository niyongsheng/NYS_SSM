//
//  NYSArticleCollectionListViewController.m
//  DaoCaoDui_IOS
//
...
@interface NYSArticleCollectionListViewController () <UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) NSMutableArray *datasourceArray;
@property (nonatomic, assign) NSInteger pageNum;

@end

@implementation NYSArticleCollectionListViewController
